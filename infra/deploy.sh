...
echo "   Grant it permission to run VM commands in this resource group."
echo ""
...
echo ""
echo "4. (Optional) Add GITHUB_RELEASE_DOWNLOAD_TOKEN as a repository secret for private repo downloads."
echo "   If you skip it, the demo workflow falls back to the per-run GitHub token during deployment."
echo ""
echo "5. Configure a federated credential on the Azure AD app for this repository/branch."
echo "   The workflow will publish a GitHub Release asset and deploy via Azure VM Run Command."
echo ""
echo "6. Push your code to the 'main' branch to trigger the deployment workflow."
echo ""
echo "7. Test the app:"
